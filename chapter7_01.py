...
# MNIST 데이터 다운, float32로 변경, 784차원으로 flattening, [0, 1]값으로 Normalize, one-hot cording
...
class CNN(object):
    ...
    def __init__(self):
        ...
        # truncated_normal : 절단정규분포로부터의 난수값을 반환
    ...
    def __call__(self, x):
        # MNIST 데이터를 3차원 형태로 reshape, MNIST는 grayscale 이미지이므로 3번째차원의 값은 1
...
# 정확도 99.12%, Epoch 8900부터 100% 정확도